...
const createTogetherList = async (
  ...
  try {
    ...
    const togetherListCategoryArray = await togetherCategoryResponse(client, togetherListId);
    const myListCategoryArray = await aloneCategoryResponse(client, myListId);
    ...
    const data: TogetherListResponseDto = {
      ...
      togetherPackingList: {
        ...
        category: togetherListCategoryArray.category,
        inviteCode: etcData.inviteCode,
        isSaved: etcData.isSaved,
      },
      myPackingList: {
        id: myListId.toString(),
        category: myListCategoryArray.category,
      },
    };
